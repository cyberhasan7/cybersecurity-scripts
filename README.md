...
## 🔐 Tool 17: Password Breach Checker

Checks if a given password has appeared in known data breaches using the HaveIBeenPwned API.

### ⚡ Features
- Uses only a **partial hash** → no password exposure.
- Quick and privacy-safe.
- Great for personal password audits.
...
### Example Output
```
Enter your password to check: mysecret123
❌ Password found in data breach! (Seen 5421 times)
```
or  
```
✅ Password not found in known breaches. You’re safe!
```
